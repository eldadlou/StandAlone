...
namespace MyGame.Core.Units.Combat
{
    ...
    /// <summary>
    /// Types of weapons that can be mounted on vehicles
    /// </summary>
    public enum WeaponType
    {
        MainCannon,     // Heavy, slow-firing cannon (tanks)
        MachineGun,     // Fast-firing, lower damage
        AutoCannon,     // Medium caliber, burst fire
        Missile,        // Guided projectile
        Mortar,         // Indirect fire
        Flamethrower,   // Short range, area damage
        RocketPod       // Multiple unguided rockets
    }
}
